...
void VeinsInetSampleMessage::copy(const VeinsInetSampleMessage& other)
{
    ...
    this->emergencyBrake = other.emergencyBrake;
}
...
void VeinsInetSampleMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->emergencyBrake);
}
...
void VeinsInetSampleMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->emergencyBrake);
}
...
double VeinsInetSampleMessage::getPosition() const
{
    return this->position;
}

void VeinsInetSampleMessage::setPosition(double position)
{
    handleChange();
    this->position = position;
}

bool VeinsInetSampleMessage::getEmergencyBrake() const
{
    return this->emergencyBrake;
}

void VeinsInetSampleMessage::setEmergencyBrake(bool emergencyBrake)
{
    handleChange();
...
unsigned int VeinsInetSampleMessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_emergencyBrake
    };
...
int VeinsInetSampleMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "emergencyBrake") == 0) return baseIndex + 3;
...
std::string VeinsInetSampleMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_position: return double2string(pp->getPosition());
        case FIELD_emergencyBrake: return bool2string(pp->getEmergencyBrake());
        default: return "";
    }
}
...
void VeinsInetSampleMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_position: pp->setPosition(string2double(value)); break;
        case FIELD_emergencyBrake: pp->setEmergencyBrake(string2bool(value)); break;
...
omnetpp::cValue VeinsInetSampleMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_position: return pp->getPosition();
        case FIELD_emergencyBrake: return pp->getEmergencyBrake();
...
void VeinsInetSampleMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_position: pp->setPosition(value.doubleValue()); break;
        case FIELD_emergencyBrake: pp->setEmergencyBrake(value.boolValue()); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'VeinsInetSampleMessage'", field);
    }
}
