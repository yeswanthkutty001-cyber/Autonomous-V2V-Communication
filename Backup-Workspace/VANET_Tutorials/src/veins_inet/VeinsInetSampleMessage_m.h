...
/**
 * Class generated from <tt>veins_inet/VeinsInetSampleMessage.msg:5</tt> by opp_msgtool.
 * <pre>
...
class VeinsInetSampleMessage : public ::inet::FieldsChunk
{
  ...
  public:
    ...
    virtual bool getRequestJunction() const;
    virtual void setRequestJunction(bool requestJunction);
};
